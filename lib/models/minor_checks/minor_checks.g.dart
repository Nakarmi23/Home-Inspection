...
Door _$DoorFromJson(Map<String, dynamic> json) {
  return Door(
    ...
    otherFixturesCondition: (json['otherFixturesCondition'] as List)
        ?.map((e) => e == null
            ? null
            : MinorChecksCondition.fromJson(e as Map<String, dynamic>))
        ?.toList(),
  );
}
...
Map<String, dynamic> _$DoorToJson(Door instance) => <String, dynamic>{
      ...
      'otherFixturesCondition':
          instance.otherFixturesCondition?.map((e) => e?.toJson())?.toList(),
    };
...
Ceiling _$CeilingFromJson(Map<String, dynamic> json) {
  return Ceiling(
    ...
    otherProblemCondition: (json['otherProblemCondition'] as List)
        ?.map((e) => e == null
            ? null
            : MinorChecksCondition.fromJson(e as Map<String, dynamic>))
        ?.toList(),
...
Map<String, dynamic> _$CeilingToJson(Ceiling instance) => <String, dynamic>{
      ...
      'otherProblemCondition':
          instance.otherProblemCondition?.map((e) => e?.toJson())?.toList(),
      'photos': instance.photos,
      'comment': instance.comment,
    };
...
ElectricalFitting _$ElectricalFittingFromJson(Map<String, dynamic> json) {
  return ElectricalFitting(
    ...
    otherAccessoriesCondition: (json['otherAccessoriesCondition'] as List)
        ?.map((e) => e == null
            ? null
            : MinorChecksCondition.fromJson(e as Map<String, dynamic>))
        ?.toList(),
...
Map<String, dynamic> _$ElectricalFittingToJson(ElectricalFitting instance) =>
    <String, dynamic>{
      ...
      'otherAccessoriesCondition':
          instance.otherAccessoriesCondition?.map((e) => e?.toJson())?.toList(),
      'age': instance.age,
      'photos': instance.photos,
      'comment': instance.comment,
    };
